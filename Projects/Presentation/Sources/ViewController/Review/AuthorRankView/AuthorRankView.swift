...
extension AuthorRankView {
    private var authors: [Author] {
        [
            Author(rank: 1, imageUrl: "image1", name: "이태영", systemImage: MukgenKitAsset.Assets.starImage.image, detail1: "5.0", detail2: " | 리뷰 99개"),
            Author(rank: 2, imageUrl: "image2", name: "햄스터", systemImage: MukgenKitAsset.Assets.starImage.image, detail1: "5.0", detail2: " | 리뷰 99개"),
            Author(rank: 3, imageUrl: "image3", name: "ㄱㅇㅇ", systemImage:MukgenKitAsset.Assets.starImage.image, detail1: "5.0", detail2: " | 리뷰 99개")
        ]
    }
}
