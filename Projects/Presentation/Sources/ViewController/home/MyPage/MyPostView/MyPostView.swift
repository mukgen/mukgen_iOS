...
extension MyPostView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            cell.myPostImage.image = MukgenKitAsset.Assets.myPostStar.image
            cell.myPostText.text = "내 리뷰"
            return cell
            
        case 1:
            cell.myPostImage.image = MukgenKitAsset.Assets.myPostBoard.image
            cell.myPostText.text = "내 게시글"
            return cell
            
        case 2:
            cell.myPostImage.image = MukgenKitAsset.Assets.myPostSuggestion.image
            cell.myPostText.text = "내 급식 건의"
            return cell
            
        case 3:
            cell.myPostImage.image = MukgenKitAsset.Assets.myPostDelivery.image
