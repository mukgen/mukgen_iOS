...
extension CafeteriaView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == 0 {
            cell.breakfastImage.image = MukgenKitAsset.Assets.breakfastImage.image
        ...
        if indexPath.row == 1 {
            cell.breakfastImage.image = MukgenKitAsset.Assets.lunch.image
        ...
        if indexPath.row == 2 {
            cell.breakfastImage.image = MukgenKitAsset.Assets.night.image
