...
extension SelectMealView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            cell.riceTypeImage.image = MukgenKitAsset.Images.breakfastImage.image
        case 1:
            cell.riceTypeLabel.text = "점심"
            cell.riceTypeImage.image = MukgenKitAsset.Images.lunch.image
        case 2:
            cell.riceTypeLabel.text = "저녁"
            cell.riceTypeImage.image = MukgenKitAsset.Images.night.image
        default:
            break
        }
